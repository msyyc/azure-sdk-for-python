...
"""
# x-ms-original-file: specification/deviceupdate/data-plane/Microsoft.DeviceUpdate/preview/2021-06-01-preview/examples/DeviceManagement_GetDeviceModule.json
def main():
    """
    ...
    response = client.device_management.get_device_module(
        device_id="deviceId",
        module_id="moduleId",
    )
    print(response)
