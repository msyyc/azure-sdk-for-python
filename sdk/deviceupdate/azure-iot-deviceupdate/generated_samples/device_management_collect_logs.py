...
"""
# x-ms-original-file: specification/deviceupdate/data-plane/Microsoft.DeviceUpdate/preview/2021-06-01-preview/examples/DeviceManagement_CollectLogs.json
def main():
    """
    ...
    response = client.device_management.collect_logs(
        ...
        log_collection_request={
            ...
            "deviceList": [
                {"deviceId": "DeviceA"},
                {"deviceId": "DeviceB", "moduleId": "ModuleB"},
            ],
        },
    )
    print(response)
