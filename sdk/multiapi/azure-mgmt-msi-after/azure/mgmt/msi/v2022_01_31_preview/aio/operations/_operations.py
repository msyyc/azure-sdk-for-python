...
from ...operations._operations import build_operations_list_request, build_system_assigned_identities_get_by_scope_request, build_user_assigned_identities_create_or_update_request
T = TypeVar('T')
...
class Operations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.msi.v2022_01_31_preview.models.OperationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
