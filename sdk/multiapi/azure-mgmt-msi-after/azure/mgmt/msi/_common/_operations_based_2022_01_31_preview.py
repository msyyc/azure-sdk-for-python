...
import _models_based_2022_01_31_preview as _models
...
def build_system_assigned_identities_get_by_scope_request(
    scope: str,
    **kwargs: Any
) -> HttpRequest:
    ...
    api_version = kwargs.pop('api_version', _params.pop('api-version'))  # type: str
...
class SystemAssignedIdentitiesOperations:
    ...
    def get_by_scope(
        ...
        **kwargs: Any
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._api_version))  # type: str
...
class Operations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.msi.v2022_01_31_preview.models.OperationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
