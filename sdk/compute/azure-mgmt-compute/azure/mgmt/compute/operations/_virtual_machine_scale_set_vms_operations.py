    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "virtualMachineScaleSetName": _SERIALIZER.url(
            "virtual_machine_scale_set_name", virtual_machine_scale_set_name, "str", pattern=r"^[a-zA-Z0-9-]{3,24}$"
        ),
    }
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either VirtualMachineScaleSetVM or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.models.VirtualMachineScaleSetVM]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either VirtualMachineScaleSetVM or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.VirtualMachineScaleSetVM]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
