...
class LogAnalyticsOperations:
    ...
    def _export_throttled_requests_initial(
        self, location: str, body: Union[_models.ThrottledRequestsInput, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "ThrottledRequestsInput")
    ...
    def begin_export_throttled_requests(
        ...
        :param location: The name of Azure region. Required.
        :type location: str
        :param body: The request body. Is either a ThrottledRequestsInput type or a IO[bytes] type.
         Required.
        :type body: ~azure.mgmt.compute.models.ThrottledRequestsInput or IO[bytes]
        :return: An instance of LROPoller that returns either LogAnalyticsOperationResult or the result
         of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.LogAnalyticsOperationResult]
        :raises ~azure.core.exceptions.HttpResponseError:
