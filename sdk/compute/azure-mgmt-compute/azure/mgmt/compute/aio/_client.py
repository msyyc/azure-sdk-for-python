...
class ComputeClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype virtual_machine_scale_set_vms_ops:
     azure.mgmt.compute.aio.operations.VirtualMachineScaleSetVMSOpsOperations
    ...
    :vartype virtual_machine_extension_image_ops:
     azure.mgmt.compute.aio.operations.VirtualMachineExtensionImageOpsOperations
    ...
    :vartype virtual_machine_extension_image_type_ops:
     azure.mgmt.compute.aio.operations.VirtualMachineExtensionImageTypeOpsOperations
    ...
    :vartype virtual_machine_run_command_ops:
     azure.mgmt.compute.aio.operations.VirtualMachineRunCommandOpsOperations
    ...
    :vartype virtual_machine_scale_set_vm_run_command_ops:
     azure.mgmt.compute.aio.operations.VirtualMachineScaleSetVMRunCommandOpsOperations
    ...
    :vartype usage_operations: azure.mgmt.compute.aio.operations.UsageOperationsOperations
    ...
    :vartype virtual_machine_sizes_operations:
     azure.mgmt.compute.aio.operations.VirtualMachineSizesOperationsOperations
    ...
    :vartype virtual_machine_scale_sets_operations:
     azure.mgmt.compute.aio.operations.VirtualMachineScaleSetsOperationsOperations
    :ivar virtual_machines_operations: VirtualMachinesOperationsOperations operations
    :vartype virtual_machines_operations:
     azure.mgmt.compute.aio.operations.VirtualMachinesOperationsOperations
    ...
    :vartype virtual_machine_images_edge_zone_operations:
     azure.mgmt.compute.aio.operations.VirtualMachineImagesEdgeZoneOperationsOperations
    ...
    :vartype virtual_machine_images_operations:
     azure.mgmt.compute.aio.operations.VirtualMachineImagesOperationsOperations
    :ivar log_analytics_operations: LogAnalyticsOperationsOperations operations
    :vartype log_analytics_operations:
     azure.mgmt.compute.aio.operations.LogAnalyticsOperationsOperations
    ...
    :vartype virtual_machine_run_commands_operations:
     azure.mgmt.compute.aio.operations.VirtualMachineRunCommandsOperationsOperations
