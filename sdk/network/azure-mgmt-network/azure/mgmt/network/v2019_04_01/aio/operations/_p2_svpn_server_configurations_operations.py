...
class P2SVpnServerConfigurationsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_04_01.models.P2SVpnServerConfiguration]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_virtual_wan(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListP2SVpnServerConfigurationsResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_04_01.models.ListP2SVpnServerConfigurationsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
