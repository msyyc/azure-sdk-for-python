    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVirtualHubBgpConnectionResults or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_03_01.models.ListVirtualHubBgpConnectionResults]
    ...
    async def begin_list_learned_routes(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either PeerRouteList or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_03_01.models.PeerRouteList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
