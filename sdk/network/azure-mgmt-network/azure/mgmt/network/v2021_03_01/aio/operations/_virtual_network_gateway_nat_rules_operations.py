...
class VirtualNetworkGatewayNatRulesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_03_01.models.VirtualNetworkGatewayNatRule]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_virtual_network_gateway(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVirtualNetworkGatewayNatRulesResult or the
         result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_03_01.models.ListVirtualNetworkGatewayNatRulesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
