    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type virtual_hub_route_table_v2_parameters:
         ~azure.mgmt.network.v2021_03_01.models.VirtualHubRouteTableV2
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either VirtualHubRouteTableV2 or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_03_01.models.VirtualHubRouteTableV2]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVirtualHubRouteTableV2SResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_03_01.models.ListVirtualHubRouteTableV2SResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
