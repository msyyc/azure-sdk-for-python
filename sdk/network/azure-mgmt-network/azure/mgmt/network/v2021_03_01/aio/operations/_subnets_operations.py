...
class SubnetsOperations:
    ...
    async def begin_prepare_network_policies(
        ...
        **kwargs: Any
        ...
        :type prepare_network_policies_request_parameters:
         ~azure.mgmt.network.v2021_03_01.models.PrepareNetworkPoliciesRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    async def begin_unprepare_network_policies(
        ...
        **kwargs: Any
        ...
        :type unprepare_network_policies_request_parameters:
         ~azure.mgmt.network.v2021_03_01.models.UnprepareNetworkPoliciesRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_03_01.models.SubnetListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
