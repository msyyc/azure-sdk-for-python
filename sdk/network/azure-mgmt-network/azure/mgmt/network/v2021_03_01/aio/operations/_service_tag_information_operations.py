...
from ...operations._service_tag_information_operations import build_list_request
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ServiceTagInformationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_03_01.models.ServiceTagInformationListResult]
