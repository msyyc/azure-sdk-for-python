...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    no_address_prefixes = kwargs.pop('no_address_prefixes', None)  # type: Optional[bool]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either ServiceTagInformationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2021_03_01.models.ServiceTagInformationListResult]
