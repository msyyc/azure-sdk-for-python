    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either HubRouteTable or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_06_01.models.HubRouteTable]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListHubRouteTablesResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.ListHubRouteTablesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
