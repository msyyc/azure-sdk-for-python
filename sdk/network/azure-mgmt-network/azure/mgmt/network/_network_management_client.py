...
class NetworkManagementClient(NetworkManagementClientOperationsMixin, MultiApiClientMixin, SDKClient):
    ...
    LATEST_PROFILE = ProfileDefinition({
        _PROFILE_TAG: {
            ...
            'inbound_security_rule': '2020-06-01',
    ...
    def express_route_port_authorizations(self):
        """Instance depends on the API version:
           ...
           * 2020-07-01: :class:`ExpressRoutePortAuthorizationsOperations<azure.mgmt.network.v2020_07_01.operations.ExpressRoutePortAuthorizationsOperations>`
        """
        api_version = self._get_api_version('express_route_port_authorizations')
        if api_version == '2020-07-01':
            from .v2020_07_01.operations import ExpressRoutePortAuthorizationsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
