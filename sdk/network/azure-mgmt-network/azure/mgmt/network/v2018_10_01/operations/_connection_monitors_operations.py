...
class ConnectionMonitorsOperations(object):
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns either ConnectionMonitorResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_10_01.models.ConnectionMonitorResult]
    ...
    def begin_query(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_10_01.models.ConnectionMonitorQueryResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ConnectionMonitorQueryResult"]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either ConnectionMonitorListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2018_10_01.models.ConnectionMonitorListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
