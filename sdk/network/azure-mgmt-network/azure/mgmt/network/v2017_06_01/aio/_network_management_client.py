...
class NetworkManagementClient(NetworkManagementClientOperationsMixin):
    ...
    :vartype application_gateways:
     azure.mgmt.network.v2017_06_01.aio.operations.ApplicationGatewaysOperations
    :ivar available_endpoint_services: AvailableEndpointServicesOperations operations
    :vartype available_endpoint_services:
     azure.mgmt.network.v2017_06_01.aio.operations.AvailableEndpointServicesOperations
    ...
    :vartype express_route_circuit_authorizations:
     azure.mgmt.network.v2017_06_01.aio.operations.ExpressRouteCircuitAuthorizationsOperations
    ...
    :vartype express_route_circuit_peerings:
     azure.mgmt.network.v2017_06_01.aio.operations.ExpressRouteCircuitPeeringsOperations
    :ivar express_route_circuits: ExpressRouteCircuitsOperations operations
    :vartype express_route_circuits:
     azure.mgmt.network.v2017_06_01.aio.operations.ExpressRouteCircuitsOperations
    ...
    :vartype express_route_service_providers:
     azure.mgmt.network.v2017_06_01.aio.operations.ExpressRouteServiceProvidersOperations
    :ivar load_balancers: LoadBalancersOperations operations
    :vartype load_balancers: azure.mgmt.network.v2017_06_01.aio.operations.LoadBalancersOperations
    ...
    :vartype load_balancer_backend_address_pools:
     azure.mgmt.network.v2017_06_01.aio.operations.LoadBalancerBackendAddressPoolsOperations
    ...
    :vartype load_balancer_frontend_ip_configurations:
     azure.mgmt.network.v2017_06_01.aio.operations.LoadBalancerFrontendIPConfigurationsOperations
    :ivar inbound_nat_rules: InboundNatRulesOperations operations
    :vartype inbound_nat_rules:
     azure.mgmt.network.v2017_06_01.aio.operations.InboundNatRulesOperations
    ...
    :vartype load_balancer_load_balancing_rules:
     azure.mgmt.network.v2017_06_01.aio.operations.LoadBalancerLoadBalancingRulesOperations
    ...
    :vartype load_balancer_network_interfaces:
     azure.mgmt.network.v2017_06_01.aio.operations.LoadBalancerNetworkInterfacesOperations
    :ivar load_balancer_probes: LoadBalancerProbesOperations operations
    :vartype load_balancer_probes:
     azure.mgmt.network.v2017_06_01.aio.operations.LoadBalancerProbesOperations
    :ivar network_interfaces: NetworkInterfacesOperations operations
    :vartype network_interfaces:
     azure.mgmt.network.v2017_06_01.aio.operations.NetworkInterfacesOperations
    ...
    :vartype network_interface_ip_configurations:
     azure.mgmt.network.v2017_06_01.aio.operations.NetworkInterfaceIPConfigurationsOperations
    ...
    :vartype network_interface_load_balancers:
     azure.mgmt.network.v2017_06_01.aio.operations.NetworkInterfaceLoadBalancersOperations
    :ivar network_security_groups: NetworkSecurityGroupsOperations operations
    :vartype network_security_groups:
     azure.mgmt.network.v2017_06_01.aio.operations.NetworkSecurityGroupsOperations
    :ivar security_rules: SecurityRulesOperations operations
    :vartype security_rules: azure.mgmt.network.v2017_06_01.aio.operations.SecurityRulesOperations
    :ivar default_security_rules: DefaultSecurityRulesOperations operations
    :vartype default_security_rules:
     azure.mgmt.network.v2017_06_01.aio.operations.DefaultSecurityRulesOperations
    :ivar network_watchers: NetworkWatchersOperations operations
    :vartype network_watchers:
     azure.mgmt.network.v2017_06_01.aio.operations.NetworkWatchersOperations
    :ivar packet_captures: PacketCapturesOperations operations
    :vartype packet_captures:
     azure.mgmt.network.v2017_06_01.aio.operations.PacketCapturesOperations
    :ivar public_ip_addresses: PublicIPAddressesOperations operations
    :vartype public_ip_addresses:
     azure.mgmt.network.v2017_06_01.aio.operations.PublicIPAddressesOperations
    :ivar route_filters: RouteFiltersOperations operations
    :vartype route_filters: azure.mgmt.network.v2017_06_01.aio.operations.RouteFiltersOperations
    :ivar route_filter_rules: RouteFilterRulesOperations operations
    :vartype route_filter_rules:
     azure.mgmt.network.v2017_06_01.aio.operations.RouteFilterRulesOperations
    :ivar route_tables: RouteTablesOperations operations
    :vartype route_tables: azure.mgmt.network.v2017_06_01.aio.operations.RouteTablesOperations
    :ivar routes: RoutesOperations operations
    :vartype routes: azure.mgmt.network.v2017_06_01.aio.operations.RoutesOperations
    :ivar bgp_service_communities: BgpServiceCommunitiesOperations operations
    :vartype bgp_service_communities:
     azure.mgmt.network.v2017_06_01.aio.operations.BgpServiceCommunitiesOperations
    :ivar usages: UsagesOperations operations
    :vartype usages: azure.mgmt.network.v2017_06_01.aio.operations.UsagesOperations
    :ivar virtual_networks: VirtualNetworksOperations operations
    :vartype virtual_networks:
     azure.mgmt.network.v2017_06_01.aio.operations.VirtualNetworksOperations
    :ivar subnets: SubnetsOperations operations
    :vartype subnets: azure.mgmt.network.v2017_06_01.aio.operations.SubnetsOperations
    :ivar virtual_network_peerings: VirtualNetworkPeeringsOperations operations
    :vartype virtual_network_peerings:
     azure.mgmt.network.v2017_06_01.aio.operations.VirtualNetworkPeeringsOperations
    :ivar virtual_network_gateways: VirtualNetworkGatewaysOperations operations
    :vartype virtual_network_gateways:
     azure.mgmt.network.v2017_06_01.aio.operations.VirtualNetworkGatewaysOperations
    ...
    :vartype virtual_network_gateway_connections:
     azure.mgmt.network.v2017_06_01.aio.operations.VirtualNetworkGatewayConnectionsOperations
    :ivar local_network_gateways: LocalNetworkGatewaysOperations operations
    :vartype local_network_gateways:
     azure.mgmt.network.v2017_06_01.aio.operations.LocalNetworkGatewaysOperations
