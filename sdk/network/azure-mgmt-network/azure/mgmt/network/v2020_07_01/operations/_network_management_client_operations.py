...
class NetworkManagementClientOperationsMixin(object):
    ...
    def begin_put_bastion_shareable_link(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_07_01.models.BastionShareableLinkListResult]
    ...
    def begin_get_active_sessions(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_07_01.models.BastionActiveSessionListResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
