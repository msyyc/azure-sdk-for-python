...
class CustomIpPrefixListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["CustomIpPrefix"]] = None,
        next_link: Optional[str] = None,
        **kwargs
    ):
...
class DscpConfigurationListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["DscpConfiguration"]] = None,
        **kwargs
    ):
...
class ExpressRoutePortAuthorization(SubResource):
    ...
    :ivar circuit: The reference to the ExpressRoute circuit resource using the authorization.
...
class ExpressRoutePortAuthorizationListResult(msrest.serialization.Model):
    """Response for ListExpressRoutePortAuthorizations API service call.

    :param value: The authorizations in an ExpressRoute Port.
    :type value: list[~azure.mgmt.network.v2020_07_01.models.ExpressRoutePortAuthorization]
    :param next_link: The URL to get the next set of results.
    :type next_link: str
    """
    ...
    def __init__(
        self,
        *,
        value: Optional[List["ExpressRoutePortAuthorization"]] = None,
        next_link: Optional[str] = None,
        **kwargs
    ):
        super(ExpressRoutePortAuthorizationListResult, self).__init__(**kwargs)
        self.value = value
        self.next_link = next_link
...
class HubRouteTable(SubResource):
    ...
    :vartype associated_connections: list[~azure.mgmt.network.v2020_07_01.models.SubResource]
    :ivar propagating_connections: List of all connections that advertise to this route table.
    :vartype propagating_connections: list[~azure.mgmt.network.v2020_07_01.models.SubResource]
...
class LoadBalancerSku(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        tier: Optional[Union[str, "LoadBalancerSkuTier"]] = None,
        **kwargs
    ):
