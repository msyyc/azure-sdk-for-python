...
class VirtualNetworksOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_07_01.models.VirtualNetwork
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2020_07_01.models.VirtualNetwork
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
        ...
        :return: An instance of AsyncLROPoller that returns either VirtualNetwork or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_07_01.models.VirtualNetwork]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.AsyncPollingMethod]
    ...
    def list_all(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either VirtualNetworkListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_07_01.models.VirtualNetworkListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def check_ip_address_availability(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_07_01.models.IPAddressAvailabilityResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_usage(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either VirtualNetworkListUsageResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_07_01.models.VirtualNetworkListUsageResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
