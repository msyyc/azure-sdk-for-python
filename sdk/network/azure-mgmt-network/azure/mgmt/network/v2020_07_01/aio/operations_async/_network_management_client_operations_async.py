...
class NetworkManagementClientOperationsMixin:
    ...
    async def begin_put_bastion_shareable_link(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_07_01.models.BastionShareableLinkListResult]
    ...
    async def begin_get_active_sessions(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_07_01.models.BastionActiveSessionListResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
