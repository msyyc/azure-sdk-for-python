...
class ExpressRouteGatewaysOperations:
    ...
    async def begin_create_or_update(
     ...
     operation.
        :type put_express_route_gateway_parameters: ~azure.mgmt.network.v2020_07_01.models.ExpressRouteGateway
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_07_01.models.ExpressRouteGateway]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_07_01.models.ExpressRouteGateway
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ExpressRouteGateway"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
