...
class VpnServerConfigurationsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_11_01.models.VpnServerConfiguration
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type vpn_server_configuration_parameters:
         ~azure.mgmt.network.v2020_11_01.models.VpnServerConfiguration
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either VpnServerConfiguration or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_11_01.models.VpnServerConfiguration]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :type vpn_server_configuration_parameters: ~azure.mgmt.network.v2020_11_01.models.TagsObject
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VpnServerConfiguration, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_11_01.models.VpnServerConfiguration
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVpnServerConfigurationsResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_11_01.models.ListVpnServerConfigurationsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
