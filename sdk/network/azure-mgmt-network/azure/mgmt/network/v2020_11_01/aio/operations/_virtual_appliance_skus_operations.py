...
class VirtualApplianceSkusOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either NetworkVirtualApplianceSkuListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_11_01.models.NetworkVirtualApplianceSkuListResult]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_11_01.models.NetworkVirtualApplianceSku
        :raises: ~azure.core.exceptions.HttpResponseError
        """
