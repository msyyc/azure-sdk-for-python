    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns either VpnGatewayNatRule or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_11_01.models.VpnGatewayNatRule]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_vpn_gateway(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either ListVpnGatewayNatRulesResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_11_01.models.ListVpnGatewayNatRulesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
