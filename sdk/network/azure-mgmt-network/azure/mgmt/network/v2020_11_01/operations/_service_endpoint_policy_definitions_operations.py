...
class ServiceEndpointPolicyDefinitionsOperations(object):
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_11_01.models.ServiceEndpointPolicyDefinition]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.PollingMethod]
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either ServiceEndpointPolicyDefinitionListResult or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_11_01.models.ServiceEndpointPolicyDefinitionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
