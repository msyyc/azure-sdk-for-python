    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either HubIpConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_02_01.models.HubIpConfiguration]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVirtualHubIpConfigurationResults or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.ListVirtualHubIpConfigurationResults]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
