...
class VpnConnectionsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_02_01.models.VpnConnection
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type vpn_connection_parameters: ~azure.mgmt.network.v2021_02_01.models.VpnConnection
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either VpnConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_02_01.models.VpnConnection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    async def begin_start_packet_capture(
        ...
        **kwargs: Any
        ...
        :param parameters: Vpn Connection packet capture parameters supplied to start packet capture on
         gateway connection.
        :type parameters:
         ~azure.mgmt.network.v2021_02_01.models.VpnConnectionPacketCaptureStartParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    async def begin_stop_packet_capture(
        ...
        **kwargs: Any
        ...
        :param parameters: Vpn Connection packet capture parameters supplied to stop packet capture on
         gateway connection.
        :type parameters:
         ~azure.mgmt.network.v2021_02_01.models.VpnConnectionPacketCaptureStopParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    def list_by_vpn_gateway(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVpnConnectionsResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.ListVpnConnectionsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
