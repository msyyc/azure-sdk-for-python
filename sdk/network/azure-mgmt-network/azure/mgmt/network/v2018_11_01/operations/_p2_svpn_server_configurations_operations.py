    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns either P2SVpnServerConfiguration or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_11_01.models.P2SVpnServerConfiguration]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_virtual_wan(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either ListP2SVpnServerConfigurationsResult or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2018_11_01.models.ListP2SVpnServerConfigurationsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
