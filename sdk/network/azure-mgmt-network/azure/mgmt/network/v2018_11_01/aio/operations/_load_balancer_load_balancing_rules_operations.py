...
class LoadBalancerLoadBalancingRulesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2018_11_01.models.LoadBalancerLoadBalancingRuleListResult]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2018_11_01.models.LoadBalancingRule
        :raises: ~azure.core.exceptions.HttpResponseError
        """
