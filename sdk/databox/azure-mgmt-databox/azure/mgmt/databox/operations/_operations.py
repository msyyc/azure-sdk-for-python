...
class JobsOperations:
    ...
    def begin_create(
        ...
        :param job_resource: Job details from request body. Is either a JobResource type or a IO type.
         Required.
        :type job_resource: ~azure.mgmt.databox.models.JobResource or IO
    ...
    begin_create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}'}
    ...
    begin_delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}'}
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type job_resource_update_parameter:
         ~azure.mgmt.databox.models.JobResourceUpdateParameter or IO
    ...
    begin_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}'}
    ...
    def cancel(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param cancellation_reason: Reason for cancellation. Is either a CancellationReason type or a
         IO type. Required.
        :type cancellation_reason: ~azure.mgmt.databox.models.CancellationReason or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_credentials(
        ...
        :return: An iterator like instance of either UnencryptedCredentials or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.databox.models.UnencryptedCredentials]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def mark_devices_shipped(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type mark_devices_shipped_request:
         ~azure.mgmt.databox.models.MarkDevicesShippedRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    mark_devices_shipped.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}/markDevicesShipped'}
...
class ServiceOperations:
    ...
    def list_available_skus_by_resource_group(
        ...
        **kwargs: Any
        ...
        :type available_sku_request: ~azure.mgmt.databox.models.AvailableSkuRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def region_configuration(
        ...
        :type region_configuration_request:
         ~azure.mgmt.databox.models.RegionConfigurationRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def validate_address(
        ...
        :param validate_address: Shipping address of the customer. Is either a ValidateAddress type or
         a IO type. Required.
        :type validate_address: ~azure.mgmt.databox.models.ValidateAddress or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def validate_inputs(
        ...
        :param validation_request: Inputs of the customer. Is either a ValidationRequest type or a IO
         type. Required.
        :type validation_request: ~azure.mgmt.databox.models.ValidationRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def mitigate(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param mitigate_job_request: Mitigation Request. Is either a MitigateJobRequest type or a IO
         type. Required.
        :type mitigate_job_request: ~azure.mgmt.databox.models.MitigateJobRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
