...
class CertificateOperations(object):
    ...
    def list_by_service(
        ...
        :rtype:
         ~azure.mgmt.apimanagement.models.CertificateContractPaged[~azure.mgmt.apimanagement.models.CertificateContract]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.CertificateContractPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_entity_tag(
            self, resource_group_name, service_name, certificate_id, custom_headers=None, raw=False, **operation_config):
        """Gets the entity state (Etag) version of the certificate specified by
        its identifier.
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: CertificateContract or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.apimanagement.models.CertificateContract or
    ...
    def create_or_update(
        ...
        :raises:
         :class:`ErrorResponseException<azure.mgmt.apimanagement.models.ErrorResponseException>`
        """
        parameters = models.CertificateCreateOrUpdateParameters(data=data, password=password)
    ...
    def delete(
            self, resource_group_name, service_name, certificate_id, if_match, custom_headers=None, raw=False, **operation_config):
