...
class InvoicesOperations(object):
    ...
    def download_multiple_modern_invoice(
        ...
        """Gets a URL to download an multiple invoices as a zip file. The
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    download_multiple_modern_invoice.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/downloadInvoices'}
    ...
    def download_multiple_billing_subscription_invoice(
        ...
        """Gets a URL to download multiple invoices as a zip file.
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    download_multiple_billing_subscription_invoice.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/default/billingSubscriptions/{subscriptionId}/downloadInvoices'}
