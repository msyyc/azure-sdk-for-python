...
class ApplicationsOperations(object):
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ApplicationPatchable"
        ...
        :rtype: ~azure.mgmt.resource.managedapplications.models.ApplicationPatchable
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ApplicationPatchable"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2018-06-01"
        content_type = kwargs.pop("content_type", "application/json")
