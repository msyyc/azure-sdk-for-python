...
class ExportsOperations:
    ...
    async def list(self, scope: str, *, expand: Optional[str] = None, **kwargs: Any) -> JSON:
    ...
    @distributed_trace_async
    async def get(self, scope: str, export_name: str, *, expand: Optional[str] = None, **kwargs: Any) -> JSON:
    ...
    @distributed_trace_async
    async def create_or_update(self, scope: str, export_name: str, parameters: Union[JSON, IO], **kwargs: Any) -> JSON:
        """The operation to create or update a export. Update operation requires latest eTag to be set in
        the request. You may obtain the latest eTag by performing a get operation. Create operation
        does not require eTag.
    ...
    @distributed_trace_async
    async def get_execution_history(self, scope: str, export_name: str, **kwargs: Any) -> JSON:
...
class GenerateDetailedCostReportOperations:
    ...
    async def _create_operation_initial(self, scope: str, parameters: Union[JSON, IO], **kwargs: Any) -> Optional[JSON]:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
...
class GenerateDetailedCostReportOperationResultsOperations:
    ...
    @distributed_trace_async
    async def get(self, operation_id: str, scope: str, **kwargs: Any) -> Optional[JSON]:
...
class GenerateDetailedCostReportOperationStatusOperations:
    ...
    @distributed_trace_async
    async def get(self, operation_id: str, scope: str, **kwargs: Any) -> JSON:
...
class ViewsOperations:
    ...
    @distributed_trace
    def list_by_scope(self, scope: str, **kwargs: Any) -> AsyncIterable[JSON]:
    ...
    @distributed_trace_async
    async def get(self, view_name: str, **kwargs: Any) -> JSON:
    ...
    @distributed_trace_async
    async def create_or_update(self, view_name: str, parameters: Union[JSON, IO], **kwargs: Any) -> JSON:
        """The operation to create or update a view. Update operation requires latest eTag to be set in
        the request. You may obtain the latest eTag by performing a get operation. Create operation
        does not require eTag.
    ...
    @distributed_trace_async
    async def get_by_scope(self, scope: str, view_name: str, **kwargs: Any) -> JSON:
    ...
    @distributed_trace_async
    async def create_or_update_by_scope(
        self, scope: str, view_name: str, parameters: Union[JSON, IO], **kwargs: Any
    ) -> JSON:
        """The operation to create or update a view. Update operation requires latest eTag to be set in
        the request. You may obtain the latest eTag by performing a get operation. Create operation
        does not require eTag.
...
class AlertsOperations:
    ...
    @distributed_trace_async
    async def list(self, scope: str, **kwargs: Any) -> JSON:
    ...
    @distributed_trace_async
    async def get(self, scope: str, alert_id: str, **kwargs: Any) -> JSON:
    ...
    @distributed_trace_async
    async def dismiss(self, scope: str, alert_id: str, parameters: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Dismisses the specified alert.
    ...
    async def list_external(
        self, external_cloud_provider_type: str, external_cloud_provider_id: str, **kwargs: Any
    ) -> JSON:
...
class QueryOperations:
    ...
    @distributed_trace_async
    async def usage(self, scope: str, parameters: Union[JSON, IO], **kwargs: Any) -> Optional[JSON]:
        """Query the usage data for scope defined.
